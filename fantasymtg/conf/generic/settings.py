...
ROOT_URLCONF = 'fantasymtg.conf.urls.main'
...
WSGI_APPLICATION = 'fantasymtg.conf.wsgi.app.application'
...
# Logging
LOG_PATH = os.path.join(VIRTUALENV_DIR, 'var/log/django/fantasymtg.log')
...
DEFAULT_FROM_EMAIL = 'admin@fantasymtg.com'
